...
const badgeUrlTemplate = 'https://img.shields.io/visual-studio-marketplace/last-updated/{extensionId}';

export class VsMarketplaceLastUpdatedMatcher implements BadgeMatcher {
  match(link: BadgeLinkInfo): MatcherResult | null {
    ...
    if (match) {
      ...
      return {
        ...
        badgeType: 'vsMarketplaceLastUpdated',
      };
    }
    return null;
  }

...
const badgeUrlTemplate = 'https://img.shields.io/visual-studio-marketplace/r/{extensionId}';

export class VsMarketplaceRatingMatcher implements BadgeMatcher {

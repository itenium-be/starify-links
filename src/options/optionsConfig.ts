...
export const badgeCategories: BadgeCategory[] = [
  ...
  },
  {
    ...
    badges: [
      ...
      { key: 'vsMarketplaceInstalls', label: 'VS Code Marketplace Installs', docsUrl: 'https://shields.io/badges/visual-studio-marketplace-installs' },
      { key: 'vsMarketplaceDownloads', label: 'VS Code Marketplace Downloads', docsUrl: 'https://shields.io/badges/visual-studio-marketplace-downloads' },
      { key: 'vsMarketplaceRating', label: 'VS Code Marketplace Rating', docsUrl: 'https://shields.io/badges/visual-studio-marketplace-rating' },
      { key: 'vsMarketplaceLastUpdated', label: 'VS Code Marketplace Last Updated', docsUrl: 'https://shields.io/badges/visual-studio-marketplace-last-updated' },
